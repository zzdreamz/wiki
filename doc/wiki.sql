...
insert into `ebook`(id,name,description) values (2,'Vue 入门教程','零基础入门vue 开发,企业级应用开发最住首选框架');
insert into `ebook`(id,name,description) values (3,'Python 入门教程','零基础入门Python 开发,企业级应用开发最佳首选框架');
insert into `ebook`(id,name,description) values (4,'mysql 入门教程','零基础入门mysql,企业级应用开发最佳首选框架');
...
insert into `category` (id,parent,name,sort) values (200,800,'Java', 200);
